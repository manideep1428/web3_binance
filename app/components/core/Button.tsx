...
export const SuccessButton = ({ className , children, onClick }: { className?:string , children: string, onClick: () => void }) => {
    return <button onClick={onClick} type="button" className={`text-center font-semibold rounded-lg focus:ring-green-200 focus:none focus:outline-none hover:opacity-90 disabled:opacity-80 disabled:hover:opacity-80 relative overflow-hidden h-[32px] text-sm px-3 py-1.5 mr-4 ${className}`}  >
...
export const SignButton = ({  className ,children, onClick }: {  className?:string ,children: string, onClick?: () => void }) => {
    return <button onClick={onClick} type="button" className= {`text-center font-semibold rounded-lg text-black focus:ring-white focus:none focus:outline-none hover:opacity-90 disabled:opacity-80 disabled:hover:opacity-80 relative overflow-hidden h-[32px] text-sm px-3 py-1.5 mr-4 dark:text-white ${className}`}>
