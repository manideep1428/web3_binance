            ...
            <main className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8 p-4 sm:p-6">
                ...
                <div className="p-4 sm:p-6">
                    ...
                    <div className="grid grid-cols-[auto_1fr] items-center gap-4">
                        ...
                        <div className="text-sm text-muted-foreground">$7,500 (at $30,000 per BTC)</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-[auto_1fr] items-center gap-4">
                        <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm text-muted-foreground">$3,000 (at $2,000 per ETH)</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-[auto_1fr] items-center gap-4">
                        <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm text-muted-foreground">$500 (at $0.10 per DOGE)</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-[auto_1fr] items-center gap-4">
                        <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm text-muted-foreground">$100 (at $200 per LTC)</div>
                        </div>
                    </div>
